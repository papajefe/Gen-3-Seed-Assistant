...
private:
    QStringList header = { tr("Advances"), tr("Slot"), tr("Level"), tr("PID"), tr("Seed"), tr("Nature"), tr("Ability"), tr("HP"),
                           tr("Atk"),   tr("Def"),  tr("SpA"),   tr("SpD"), tr("Spe"),   tr("Hidden"), tr("Shiny"),   tr("Gender") };
};
